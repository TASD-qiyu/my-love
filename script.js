...
function renderLetter(container) {
  ...
  container.innerHTML = '<div class="letter-container"><div class="letter-envelope" id="letterEnvelope"></div><div class="letter-text" id="letterText" style="opacity:0;transition:opacity 0.5s;">' + letter.replace(/\n/g, '<br>') + '</div></div>';
  setTimeout(function() {
    var env = document.getElementById('letterEnvelope');
    if (env) {
      env.addEventListener('click', function() {
        this.style.transform = 'translateY(-20px)';
        setTimeout(function() {
          var textEl = document.getElementById('letterText');
